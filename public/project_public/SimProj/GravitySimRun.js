...
// include: C:\Users\JOSEPH~1\AppData\Local\Temp\tmpdveu86ad.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'web_build/GravitySimRun.data';
      var REMOTE_PACKAGE_BASE = 'GravitySimRun.data';
...
Module['FS_createPath']("/", "shaders", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_web_build/GravitySimRun.data');
      }
      Module['addRunDependency']('datafile_web_build/GravitySimRun.data');
    ...
    loadPackage({"files": [{"filename": "/shaders/fragment.glsl", "start": 0, "end": 89}, {"filename": "/shaders/grid.glsl", "start": 89, "end": 859}, {"filename": "/shaders/grid_fragment.glsl", "start": 859, "end": 1781}, {"filename": "/shaders/grid_vertex.glsl", "start": 1781, "end": 1982}, {"filename": "/shaders/vertex.glsl", "start": 1982, "end": 2217}], "remote_package_size": 2217});
...
function findWasmBinary() {
  return locateFile('GravitySimRun.wasm');
}
